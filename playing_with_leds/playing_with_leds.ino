...
#include "FastLED.h"
#define DATA_PIN_ONE 3
#define DATA_PIN_TWO 5
#define DATA_PIN_THREE 7
#define DATA_PIN_FOUR 9
...
void setup() {
  ...
  FastLED.addLeds<LED_TYPE, DATA_PIN_ONE, COLOR_ORDER>(leds, NUM_LEDS_PER_STRIP).setCorrection(TypicalLEDStrip); // initializes LED strip
  FastLED.addLeds<LED_TYPE, DATA_PIN_TWO, COLOR_ORDER>(leds, NUM_LEDS_PER_STRIP).setCorrection(TypicalLEDStrip);
  FastLED.addLeds<LED_TYPE, DATA_PIN_THREE, COLOR_ORDER>(leds, NUM_LEDS_PER_STRIP).setCorrection(TypicalLEDStrip);
  FastLED.addLeds<LED_TYPE, DATA_PIN_FOUR, COLOR_ORDER>(leds, NUM_LEDS_PER_STRIP).setCorrection(TypicalLEDStrip);
...
SimplePatternList gPatterns = { plasma, matrix_ray, blendwave, blendme, rainbow, confetti, sinelon, juggle, bpm };
